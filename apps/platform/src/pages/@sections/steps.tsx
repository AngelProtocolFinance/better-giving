  ...
  return (
    <section className={`${classes} grid content-start `}>
      ...
      >
        <Link
          to={href("/register")}
          className="btn btn-lg btn-primary inline-flex items-center font-bold"
        >
          Join us today!
        </Link>
        <Link
          to={BOOK_A_DEMO}
          className="btn btn-lg btn-secondary inline-flex items-center font-bold"
        >
          Book a Demo
        </Link>
      </motion.div>
