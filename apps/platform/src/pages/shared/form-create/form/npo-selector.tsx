  ...
  return (
    ...
    >
      ...
      <Combobox.Control className="relative">
        ...
        <Combobox.Positioner>
          <Combobox.Content className="z-floating max-h-60 w-(--reference-width) overflow-y-scroll overscroll-contain scrollbars bg-panel text-gray-12 shadow-floating rounded">
            {p.opts === "loading" ? (
