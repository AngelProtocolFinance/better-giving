  ...
  return (
    <div className={`${classes} flex relative items-center`}>
      ...
      >
        <Popover.Trigger
          disabled={isDisabled}
          className="w-full flex justify-center items-center p-3 rounded bg-primary text-primary-fg lg:text-gray-11 lg:bg-surface lg:border lg:w-[22.3rem] lg:justify-between disabled:bg-gray-11 disabled:text-gray-11 lg:disabled:bg-gray-3 focus-visible:outline-none"
        >
