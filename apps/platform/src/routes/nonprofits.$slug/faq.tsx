  ...
  return (
    <div className={`${classes} grid`}>
      <h2 className="text-center capitalize section-heading mb-4 ">
        "What's the Catch?"{" "}
        <span className="text-primary">(There&nbsp;Isn't One)</span>
      </h2>
      <div className="grid gap-y-8 justify-self-center mt-8">
        {items.map((item, index) => (
          <div
            key={index}
            className="flex @max-3xl:flex-col gap-y-4 items-center gap-x-8 last:mb-0 bg-panel p-8 rounded shadow-xl shadow-black/2"
          >
