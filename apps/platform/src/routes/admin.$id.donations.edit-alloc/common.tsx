...
export const alloc_opts = [
  {
    ...
    icon: <Trees className="icon-2xl shrink-0 text-success" />,
  },
  {
    value: "000-025-075",
    label: "Long-Term Sustainability",
    description: "25% Savings, 75% Investment",
    icon: <Sprout className="icon-2xl shrink-0 text-success" />,
  },
  {
    value: "000-050-050",
    label: "Balanced Growth",
    description: "50% Savings, 50% Investment",
    icon: <TrendingUp className="icon-xl shrink-0 text-primary" />,
  },
  {
    value: "025-050-025",
    label: "Short-Term Stability",
    description: "25% Grant, 50% Savings, 25% Investment",
    icon: <Banknote className="icon-2xl shrink-0 text-primary" />,
  },
  {
    value: "075-025-000",
    label: "Immediate Impact",
    description: "75% Grant, 25% Savings",
    icon: <Zap className="icon-2xl shrink-0 text-warning" />,
  },
];
