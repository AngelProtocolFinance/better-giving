    ...
    <section className={classes} aria-labelledby="testimonials-heading">
      <div className="page">
        ...
        <div className="grid gap-6 md:grid-cols-2 mt-24">
          <div className="bg-card border border-gray-6 rounded p-8 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-auto">
              <img
                src={fora}
                alt=""
                className="flex-none h-11 w-auto object-contain"
                aria-hidden
              />
              <div>
          ...
          <div className="relative bg-card border border-gray-6 rounded p-8 flex flex-col gap-4">
            <p className="text-base/relaxed">
