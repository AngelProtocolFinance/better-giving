...
export function Hero({ classes = "" }: IHero) {
  return (
    ...
    >
      <div className="page-narrow grid gap-12 lg:grid-cols-[minmax(22rem,1fr)_minmax(18rem,33rem)] items-center">
        <div className="grid gap-5 justify-items-start">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3.5 mt-2 w-full sm:w-auto">
            <Link
              to={href("/register")}
              className="btn btn-lg btn-primary shadow-lg shadow-primary/25 w-full sm:w-auto"
            >
              Join free forever
            </Link>
            <ExtLink
