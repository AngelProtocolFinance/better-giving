...
export function Body({ classes = "", npo, children, program }: Props) {
  return (
    ...
    >
      <div className="page-wide grid gap-8 justify-items-center h-full pt-32 pb-8 lg:grid-rows-[auto_auto_1fr] lg:grid-cols-[1fr_auto] lg:justify-items-start lg:gap-16 lg:pt-6 lg:pb-20">
        <Breadcrumbs
