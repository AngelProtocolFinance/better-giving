      ...
      {with_notif && (
        <div className="grid gap-y-3 mt-4">
          <Field
            ...
            placeholder="e.g. Jane Doe"
            classes={{ container: "[&_label]:text-sm [&_input]:text-sm" }}
            required
          ...
          <Field
            ...
            classes={{ container: "[&_label]:text-sm [&_textarea]:text-sm" }}
            required={false}
            error={errors.notif?.from_msg?.message}
          />
          <p
            data-exceed={errors.notif?.from_msg?.type === "max"}
            className="text-xs text-gray-11 -mt-2 data-[exceed='true']:text-destructive"
          >
