  ...
  return (
    <div className={`${classes} flex relative items-center`}>
      ...
      >
        <Popover.Trigger
          disabled={isDisabled}
          className="w-full flex justify-center items-center p-3 rounded bg-primary text-primary-fg lg:text-gray-11 lg:bg-input lg:w-[22.3rem] lg:justify-between disabled:bg-gray-11 disabled:text-gray-11 lg:disabled:bg-gray-3 lg:border focus-visible:outline-none"
        >
        ...
        <Portal>
          <Popover.Positioner>
            <Popover.Content
              asChild
              className="grid content-start gap-4 w-(--reference-width) rounded border bg-popover text-gray-12 origin-(--transform-origin) data-[state=open]:animate-popup-in data-[state=closed]:animate-popup-out"
            >
              <form
