      ...
      {!dismissed && (
        <div className="flex items-start gap-2 px-5 py-2 [html[data-banner-dismissed='ncnp-endorsement']_&]:hidden">
          ...
          <button
            ...
            className="shrink-0 rounded-sm p-0.5 text-primary-fg/70 hover:text-primary-fg focus-visible:text-primary-fg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-fg"
          >
            <XIcon size={16} />
          </button>
        </div>
