  ...
  return (
    <div className={classes}>
      <Menu.Root positioning={{ placement: "bottom", gutter: 8 }}>
        ...
        <Portal>
          <Menu.Positioner>
            <Menu.Content className="z-10 grid grid-cols-2 w-max p-3 rounded bg-popover text-gray-12 shadow-xl shadow-black/5 origin-(--transform-origin) data-[state=open]:animate-popup-in data-[state=closed]:animate-popup-out">
              {menuItems.map((item) => (
