...
export function Toaster({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      >
        {(toast) => (
          <Toast.Root className="bg-popover text-gray-12 border rounded shadow-lg px-4 py-3 flex items-center gap-3 data-[state=open]:animate-popup-in data-[state=closed]:animate-popup-out">
