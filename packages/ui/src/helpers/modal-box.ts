...
export const modal_box = {
  ...
  panel:
    "fixed-center rounded z-modal w-[90vw] sm:w-full sm:max-w-md max-h-[90dvh] overflow-y-auto scrollbars",
  /** 512px — the default: single-column forms and dialogs */
  sm: "fixed-center rounded z-modal w-[90vw] sm:w-full sm:max-w-lg max-h-[90dvh] overflow-y-auto scrollbars",
  /** 672px — share sheets, charts, multi-column forms */
  md: "fixed-center rounded z-modal w-[90vw] sm:w-full sm:max-w-2xl max-h-[90dvh] overflow-y-auto scrollbars",
  /** 768px — the widest: tabular admin forms, embedded third-party frames */
  lg: "fixed-center rounded z-modal w-[90vw] sm:w-full sm:max-w-3xl max-h-[90dvh] overflow-y-auto scrollbars",
} as const;
