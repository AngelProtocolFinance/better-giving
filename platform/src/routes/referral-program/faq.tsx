...
export function Faq({ classes = "" }) {
  return (
    <section className={`${classes} grid`}>
      ...
      <p className="px-6 max-w-5xl mx-auto md:text-xl text-pretty mb-10">
      ...
      <ul className="list-disc pl-5 space-y-4 text-lg">
        ...
        <li className="">
          ...
          <p>We process payouts monthly, directly to your account.</p>
        </li>
        ...
        <li>
          ...
          <p>They can manually enter your referral code during signup.</p>
        </li>
        <li>
          <strong className="">
      ...
      <ExtLink
        href={referrals_hub}
        className="justify-self-center flex mt-8 items-center gap-x-2 text-primary hover:text-primary md:text-lg font-semibold"
      >
