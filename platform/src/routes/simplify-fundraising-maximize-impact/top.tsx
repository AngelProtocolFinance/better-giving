  ...
  return (
    ...
    >
      <div className="max-w-2xl order-2 @6xl:order-1 grid">
        ...
        <h1 className="text-center @6xl:text-left text-4xl @6xl:text-5xl @6xl:leading-tight text-balance mb-4">
        ...
        <div
          className={`mt-8 z-10 justify-self-center ${is_page_b ? "" : "@6xl:justify-self-start"}  relative`}
        >
          <button
            type="button"
            onClick={async () => {
...
function Tooltip({ className = "" }) {
  return (
    <span className={className}>
      ...
      <p className="translate-x-12 -rotate-12 font-gochi text-nowrap">
        It’s totally free!
      </p>
    </span>
  );
