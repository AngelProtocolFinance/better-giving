...
export const home_faqs = [
  ...
  },
  {
    ...
    paragraphs: [
      <p key={0}>
        Register in minutes — we review and get you started right away.
        Embedding the form on your site is a copy-paste snippet, and payouts
        arrive electronically within 5 working days.
      </p>,
    ],
  },
  {
    ...
    paragraphs: [
      <p key={0}>
        ...
        you ever switch providers we actively help migrate your recurring donors
        — no exit fees, no fine print.
      </p>,
    ],
  },
  {
