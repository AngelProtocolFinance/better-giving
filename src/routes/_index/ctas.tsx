  ...
  return (
    ...
    >
      <img
        ...
        height={400}
        src={url}
        className="rounded absolute-center blur-2xl"
        alt=""
      />
      <img
        width={240}
        height={240}
        src={url}
        className="z-10 rounded absolute-center"
        alt=""
      />
    </motion.div>
  );
  ...
  return (
    ...
    >
      <article className="grid md:grid-cols-2 items-center">
        ...
        >
          <h3 className="max-md:text-center article-heading text-primary mb-2">
          ...
          <Link
            ...
            className="btn btn-primary justify-self-center md:justify-self-start inline-flex items-center px-10 py-3 font-bold rounded"
          >
            Join us today!
          </Link>
        </motion.div>
      ...
      <article className="grid md:grid-cols-2 items-center">
        ...
        <motion.div
          ...
          transition={{ type: "spring" }}
        >
          <h3 className="text-2xl md:text-3xl text-primary mb-2 max-md:text-center">
          ...
          <p className="md:text-lg mb-4 max-md:text-center">
            ...
            over 11% annually across the last 5 years (past performance isn't
            guaranteed).
          </p>
          <Link
            to={href("/register/welcome")}
  ...
  return (
    <div className={`${classes} grid md:grid-cols-2 items-center`}>
      <div className="grid order-2">
        <h4 className="text-2xl md:text-3xl text-primary mb-2">
          We help you raise more
        </h4>
        ...
        <Link
          to={href("/register/welcome")}
          className="btn btn-primary justify-self-start inline-flex items-center px-10 py-3 font-bold rounded"
        >
          Join us today!
        </Link>
      </div>
      <div className="relative order-1">
        ...
        <img
          ...
          alt="Illustration of a girl pointing up"
        />
      </div>
    </div>
  );
