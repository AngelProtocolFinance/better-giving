...
export function Video() {
  ...
  return (
    ...
    >
      ...
      <h2
        className={`${styles.heading} justify-self-center section-heading text-center mb-5 -mt-12 sm:-mt-16`}
      >
        The Better.Giving Alliance
      </h2>
      <p className="z-10 text-xl md:text-3xl font-medium text-center max-w-2xl mx-auto text-pretty mb-14">
      ...
      <div className="rounded md:rounded max-w-278 p-4 pb-12 border justify-self-center">
        ...
        <p className="mt-20 md:text-2xl font-medium text-center">
