  ...
  return (
    ...
    >
      <div className="max-w-2xl">
        ...
        <h2 className="text-center @6xl:text-left text-3xl @6xl:text-4xl @6xl:leading-tight text-pretty mb-4">
      ...
      <div className="self-center p-8 mt-4 @6xl:mt-24 max-w-3xl relative ">
        ...
        />
        <blockquote className="text-xl sm:text-2xl font-medium text-muted-fg italic mb-2 ">
