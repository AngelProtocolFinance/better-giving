...
export function Hero({ classes = "" }) {
  return (
    <section className={`${classes} grid pb-48 pt-32`}>
      ...
      <p className="px-6 max-md:block md:text-2xl text-center text-balance max-w-4xl justify-self-center sm:text-balance">
      ...
      <Link
        ...
        className="btn btn-primary mt-10 justify-self-center inline-flex items-center px-10 py-3 gap-1 rounded text-lg relative font-bold"
      >
