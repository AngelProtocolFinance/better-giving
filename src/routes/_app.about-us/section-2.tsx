...
export function Section2({ className = "" }) {
  return (
    <section className={`${className} grid`}>
      ...
      <p className="text-center mb-16 col-span-full text-xl mt-4 max-w-4xl justify-self-center">
  ...
  return (
    <li className="grid content-start @3xl:grid-rows-subgrid row-span-4 justify-items-center px-4">
      <Image
        ...
        className="mb-4"
      />
      <h5 className="text-center  font-medium text-xl @6xl:text-2xl mb-2">
        {props.title1}
      </h5>
      <h6 className="text-center self-start font-normal  text-lg @6xl:text-xl text-muted-fg mb-4">
        {props.title2}
      </h6>
