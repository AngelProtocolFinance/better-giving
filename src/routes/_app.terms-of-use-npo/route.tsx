          ...
          <ol type="a">
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  <U>External Bank Transfer Fees</U>. External fees are applied
                  by the transacting banks when funds are granted out from
                  Better Giving to a nonprofit bank account. These could include
                  just the transaction costs, or if required — currency exchange
                  costs.
                </li>
              </ol>
            </li>
