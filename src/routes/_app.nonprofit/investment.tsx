...
const items: TListItem[] = [
  {
    ...
    icon: <Bolt size={38} className="stroke-primary" />,
  },
  {
  ...
  },
  {
    ...
    icon: <Combine size={35} className="text-primary" />,
  },
];
...
export function WhyBG({ className = "" }) {
  return (
    <section className={`${className} grid`}>
      ...
      <div className="grid @3xl:grid-cols-2 items-center mb-14 p-3 rounded">
        <Image src={section_img} width={320} className="justify-self-center" />
        <div className="">
          <p className="border-b pb-2 text-2xl mb-4 mt-4 @3xl:mt-0 font-medium text-center @3xl:text-left">
      ...
      <p className="text-muted-fg text-sm text-center mt-16 max-w-2xl justify-self-center">
...
function ListItem(props: TListItem) {
  return (
    <li className="grid content-start @3xl:grid-rows-subgrid row-span-4 justify-items-center px-4">
      {props.icon}
      <h5 className="text-center  font-medium text-xl @6xl:text-2xl mt-8">
        {props.title1}
      </h5>
      <h6 className="text-center self-center font-normal  text-lg @6xl:text-xl text-muted-fg mb-4">
        {props.title2}
      </h6>
      <p className="text-center @6xl:text-lg text-muted-fg mt-4">
        {props.description}
      </p>
    </li>
  );
