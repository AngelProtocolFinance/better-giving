  ...
  return (
    ...
    >
      <div className="grid max-w-2xl order-2 @6xl:order-1">
        <h4 className="mb-4 col-span-full text-lg text-primary uppercase text-center @6xl:text-left">
          Borderless Donations
        </h4>
        <h1 className="text-center @6xl:text-left text-3xl @6xl:text-4.5xl leading-tight text-pretty mb-6">
          Globally Inclusive: We support all nonprofits and NGOs, regardless of
          their size or location
        </h1>
        <p className="mb-10 text-muted-fg text-lg @6xl:text-xl text-center @6xl:text-left">
        ...
        <Link
          ...
          className="justify-self-center text-center @6xl:justify-self-start btn btn-primary rounded px-8 py-3 @6xl:px-12 @6xl:py-6 @6xl:text-xl shadow-2xl shadow-primary/30 hover:shadow-primary/50"
        >
      ...
      <Image
        ...
        width={572}
        height={572}
        className="rounded order-1 @6xl:order-2"
      />
    </section>
  );
}
