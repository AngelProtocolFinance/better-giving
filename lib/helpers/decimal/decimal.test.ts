...
describe("common decimal helpers", () => {
  ...
  test("to currency: truncating gt 1B", () => {
    expect(humanize(1_234_567_891.2345679, 0, true)).toBe(
      //toLocalString output may vary depending on machine
      `${toPreciseLocaleString(1, 0)}B`
    );
    expect(humanize(1_234_567_891.2345679, 1, true)).toBe(
      `${toPreciseLocaleString(1.2, 1)}B`
    );
    expect(humanize(1_234_567_891.2345679, 2, true)).toBe(
      `${toPreciseLocaleString(1.23, 2)}B`
    );
    expect(humanize(1_234_567_891.2345679, 4, true)).toBe(
      `${toPreciseLocaleString(1.2345, 4)}B`
    );

    expect(humanize(1_234_567_891.2345679, 0, false)).toBe(
      //toLocalString output may vary depending on machine
      toPreciseLocaleString(1_234_567_891, 0)
    );
    expect(humanize(1_234_567_891.2345679, 1, false)).toBe(
      toPreciseLocaleString(1_234_567_891.2, 1)
    );
    expect(humanize(1_234_567_891.2345679, 2, false)).toBe(
