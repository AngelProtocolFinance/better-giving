...
export const Closed = () => (
  <div className="flex items-center justify-between w-72 border rounded px-3 py-2 bg-card">
    ...
    <DrawerIcon is_open={false} size={24} className="text-muted-fg" />
  </div>
);
...
export const Open = () => (
  <div className="w-72 border rounded bg-card overflow-clip">
    <div className="flex items-center justify-between px-3 py-2">
      <span className="text-sm">How does employer matching work?</span>
      <DrawerIcon is_open={true} size={24} className="text-muted-fg" />
    </div>
    <p className="text-sm text-muted-fg border-t px-3 py-2">
...
export const OnSelectTrigger = () => (
  <div className="flex flex-col gap-3">
    ...
    >
      ...
      <DrawerIcon is_open={false} size={20} className="text-muted-fg" />
    </button>
    <button
      type="button"
      className="flex items-center justify-between w-72 border rounded px-3 py-2 bg-card text-sm"
    >
      ...
      <DrawerIcon is_open={true} size={20} className="text-muted-fg" />
    </button>
  </div>
);
...
export const Sizes = () => (
  <div className="flex items-end gap-6 text-muted-fg">
